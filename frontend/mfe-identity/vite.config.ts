...
/**
 * MF REMOTE for identity. Exposes a single entry component that the shell
 * mounts at /login, /signup, and /admin. The component reads its `mode`
 * prop to render the right screen.
 */
